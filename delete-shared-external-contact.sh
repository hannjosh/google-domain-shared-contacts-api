...
# Step 3: Request the ID of the contact to be deleted
echo -n "Enter the ID of the contact to be deleted: "
read ID

# Step 4: Delete the specified contact
XML=$(curl -X DELETE -H "GData-Version: 3.0" -H "Authorization: Bearer $ACCESS_TOKEN" "https://www.google.com/m8/feeds/contacts/$DOMAIN/full/$ID")